...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val email = findViewById(R.id.txt_email) as EditText
        val pass = findViewById(R.id.txt_password) as EditText

        val loginClick = findViewById(R.id.btn_login) as Button
